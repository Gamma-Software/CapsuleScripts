...
if [ $? -eq 0 ]; then
    ...
    docker run -d --name travelblog -p 5000:4000 -v "/home/rudloff/sources/CapsuleScripts/servers/travelblog:/srv/jekyll" jekyll/jekyll:3.8 jekyll serve --watch --force_polling --verbose --trace
