...
print(datetime.datetime.now(), ": ", "network_scan_info: ", network_scan_info)
...
print(datetime.datetime.now(), ": ", "known_networks_info:", known_networks_info)
...
print(datetime.datetime.now(), ": ", "active_connection:", active_connection)
